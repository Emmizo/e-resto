    ...
    <div class="main-content manage-users">
        ...
        <div class="breadcrumb-section mb-2 mb-xl-4">
            <ul class="breadcrumb-lists d-flex align-items-center flex-wrap">
                ...
                <li class="breadcrumb-item position-relative">
                    <span class="breadcrumb-link font-dmsans fw-medium xsmall text-primary-v1">Edit Banner</span>
                </li>
            </ul>
        </div>
                ...
                <div class="col-xl-7 col-lg-9">
                    <div class="card shadow-sm border-0 rounded-4">
                        <div class="card-header bg-white border-0 pt-4 pb-0 px-4">
                            <h5 class="font-dmsans fw-bold text-primary-v1 mb-0">Edit Promo Banner</h5>
                        </div>
                        <div class="card-body px-4 pb-4">
                            ...
                            <form id="promoBannerForm" enctype="multipart/form-data" novalidate>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="title" id="title" class="form-control rounded-3" value="{{ old('title', $banner->title) }}" placeholder="Enter banner title" maxlength="255">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="description" id="description" class="form-control rounded-3" rows="3" placeholder="Enter banner description" maxlength="1000">{{ old('description', $banner->description) }}</textarea>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    @if($banner->image_path)
                                        <div class="mb-2" id="current-image">
                                            <img src="{{ asset(ltrim(str_replace(config('app.url'), '', $banner->image_path), '/')) }}" alt="Current Banner" class="rounded-3" style="max-height:120px;max-width:100%;object-fit:cover;">
                                            <div class="form-text text-muted mt-1">Current image — upload a new one to replace it.</div>
                                        </div>
                                    @endif
                                    ...
                                    <div id="image-preview" class="mt-2 d-none">
                                        <img src="" alt="New Preview" class="rounded-3" style="max-height:120px;max-width:100%;object-fit:cover;">
                                    </div>
                                </div>
...
$(document).ready(function() {
    ...
    $('#promoBannerForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '{{ route("promo-banners.update", $banner->id) }}',
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function(response) {
                toastr.success(response.message || 'Promo banner updated!');
                setTimeout(function() {
