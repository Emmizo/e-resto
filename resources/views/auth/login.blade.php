                    ...
                    <div class="district-left-content position-relative h-100">
                        <div class="login-left position-relative d-flex align-items-start justify-content-between flex-column h-100 animate__animated animate__fadeIn">
                            ...
                            <div class="login-left-bottom animate__animated animate__fadeInUp animate__delay-1s">
                                <h2 class="font-dmsans fw-bold medium text-white mb-4">Welcome to the FoodFinder app</h2>
                                <p class="font-dmsans fw-normal text-white lh-base">FoodFinder is an AI-Based Restaurant Recommendation System that helps users discover restaurants around their location using geolocation technology, providing personalized dining suggestions based on preferences and real-time availability.</p>
                                ...
                                <p class="font-dmsans fw-normal text-white lh-base">The FoodFinder App will serve to provide you with access to nearby restaurants, personalized meal suggestions, user reviews, and convenient table reservations based on your dining preferences and location.</p>
                                    ...
                                    <div class="tab-pane fade show active animate__animated animate__fadeIn" id="login-panel" role="tabpanel" aria-labelledby="login-tab">
                                        ...
                                        <form>
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <button type="submit" class="btn btn-primary btn-small fw-semibold text-uppercase rounded-3 w-100 text-center animate__animated animate__pulse animate__infinite animate__slow">
                                                        <span>Sign In</span>
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group m-0 mb-3">
                                                        ...
                                                        <input type="text" class="form-control rounded-3" id="firstName" name="first_name" placeholder="Enter First Name" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group m-0 mb-3">
                                                        <label for="lastName" class="form-label">Last Name <span class="asterik">*</span></label>
                                                        <input type="text" class="form-control rounded-3" id="lastName" name="last_name" placeholder="Enter Last Name" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group m-0 mb-3">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group m-0 mb-3">
                                                        ...
                                                        <input type="tel" class="form-control rounded-3" id="phoneNumber" name="phone_number" placeholder="Enter Phone Number">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group m-0 mb-3">
                                                        <label for="registerPassword" class="form-label">Password <span class="asterik">*</span></label>
                                                        <input type="password" class="form-control rounded-3" id="registerPassword" name="password" placeholder="Enter Password" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group m-0 mb-3">
                                                ...
                                                <div id="restaurantFields" class="restaurant-section d-none">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group m-0 mb-3">
                                                            ...
                                                            <input type="file" class="form-control rounded-3" id="restaurantImage" name="restaurant[image]" accept="image/*">
                                                        </div>
                                                    </div>
                                                </div>
