...
<body>
    <div class="mail-container">
        ...
        <div class="content">
            <div class="desc">
                You have received a new reservation (ID: <b>{{ $reservation->id }}</b>) for <b>{{ $reservation->reservation_time->timezone($reservation->user->timezone ?? config('app.timezone'))->format('Y-m-d H:i') }}</b>.
            </div>
            <div class="card">
                <div><strong>Customer:</strong> {{ $reservation->user->first_name }} {{ $reservation->user->last_name }}</div>
