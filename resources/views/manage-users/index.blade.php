    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-dmsans fw-medium text-primary-v1" id="editUserLabel">Edit User</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="editUserForm" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="edit_first_name" class="form-label font-dmsans fw-medium text-primary-v1">First Name</label>
                                <input type="text" class="form-control" id="edit_first_name" name="first_name" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="edit_last_name" class="form-label font-dmsans fw-medium text-primary-v1">Last Name</label>
                                <input type="text" class="form-control" id="edit_last_name" name="last_name" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <label for="edit_email" class="form-label font-dmsans fw-medium text-primary-v1">Email</label>
                        <input type="email" class="form-control" id="edit_email" name="email" required>
                    </div>
                    <div class="form-group mb-3">
                        <label for="edit_phone_number" class="form-label font-dmsans fw-medium text-primary-v1">Phone Number</label>
                        <input type="text" class="form-control" id="edit_phone_number" name="phone_number" required>
                    </div>
                    <div class="form-group mb-3">
                        <label for="edit_position" class="form-label font-dmsans fw-medium text-primary-v1">Position</label>
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label font-dmsans fw-medium text-primary-v1">Permissions</label>
                    ...
                    <div class="form-group mb-3">
                        <label for="edit_profile_picture" class="form-label font-dmsans fw-medium text-primary-v1">Profile Picture</label>
